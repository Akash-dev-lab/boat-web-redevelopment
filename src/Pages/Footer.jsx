  ...
  <footer className="bg-[#18181B] text-white w-full pt-10 pb-6 px-4">
    <div className="w-full p-10 mx-auto flex flex-col md:flex-row md:justify-between items-center gap-8">
      ...
      <div className="flex items-center flex-col md:flex-row gap-4">
        <span className="font-bold text-lg font-[Inter] tracking-wide text-red-600">
    ...
    <div className="w-full mt-8 font-[Inter] border-t border-white/10 pt-4 flex flex-col md:flex-row justify-between items-center text-gray-400 text-xs gap-2">
