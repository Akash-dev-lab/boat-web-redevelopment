        ...
        <div className="container lg:flex lg:flex-col gap-4 max-sm:flex max-sm:flex-col justify-center h-screen items-center mx-auto px-6 md:px-12 xl:px-20 py-32">
          ...
          <Link to="/products" className="mt-10 inline-block">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="inline-block backdrop-blur-xl bg-white/10 uppercase text-sm tracking-widest hover:bg-red-700 hover:text-white font-semibold cursor-pointer py-3 px-6 rounded-xl shadow-lg transition"
              style={{ fontFamily: 'Inter, sans-serif' }}
            >
              Explore Products
            </motion.button>
